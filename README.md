...
| [Maple Mono](https://font.subf.dev/) | 圆角连字编程字体，支持中英文 2:1 完美对齐（CN 版），Nerd Font 图标齐全 | 🔓 |
...
| [Gyroflow](https://gyroflow.xyz) | 开源陀螺仪防抖工具，为动作相机视频提供云台级稳定处理 | 🔓 |
...
| [AliasVault](https://www.aliasvault.net/) | 开源端到端加密密码管理器，内置邮箱别名生成器和邮件服务器，支持自托管 | 🔓 |
